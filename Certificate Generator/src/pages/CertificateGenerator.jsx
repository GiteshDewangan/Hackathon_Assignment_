...
const initialState = {
  ...
  phone: "", // new field
  email: "", // new field
  certificationId: "", // new field for certification ID
};

// Handle changes for phone and email in reducer
      ...
      <div className={styles.wrapper}>
        <div className={styles.container}>
          <form onSubmit={handleSubmitForm}>
            ...
            <div className={styles.inputGroup}>
              <label htmlFor="certificationId">Certificate Id</label>
              <input
                type="text"
            ...
            <div className={styles.inputGroup}>
              <label htmlFor="dateOfConductStart">Date of Start</label>
              <input
                type="date"
            ...
            <div className={styles.inputGroup}>
              <label htmlFor="dateOfConductEnd">Date of End</label>
              <input
                type="date"
